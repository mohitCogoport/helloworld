...
var BreadCrumbs = require('@cogoport/front/components/admin/Breadcrumbs');
...
var Container$6 = styled__default["default"].div(_templateObject$o || (_templateObject$o = _taggedTemplateLiteral(["\n\tdisplay: flex;\n\tflex-direction: row;\n    padding: 20px 0;\n    justify-content: space-between;\n"])));
var DashboardContainer = styled__default["default"].div(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n\n"])));

var _templateObject$n;
var Btn = styled__default["default"](admin.Button)(_templateObject$n || (_templateObject$n = _taggedTemplateLiteral(["\n\n    text-transform: capitalize;\n    min-width: 110px;\n    min-height: 24px;\n    font-weight: 500;\n\n    &.margin8Right{\n        margin-right: 8px;\n    }\n"])));

var _excluded$x = ["children"];

var Button = function Button(_ref) {
  var children = _ref.children,
      rest = _objectWithoutProperties$j(_ref, _excluded$x);
...
var _templateObject$m, _templateObject2$f, _templateObject3$9, _templateObject4$6, _templateObject5$6;
var GridContainer = styled__default["default"].div(_templateObject$m || (_templateObject$m = _taggedTemplateLiteral(["\n    border: 1px solid rgb(224, 224, 224);\n    border-radius: 8px;\n    height: 100%;\n    cursor: ", ";\n\n    &:active {\n        cursor: ", ";\n    }\n"])), function (props) {
  return props.isEditable ? 'grab' : 'auto';
}, function (props) {
  return props.isEditable ? 'grabbing' : 'auto';
});
styled__default["default"].div(_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral(["\n    border: 1px solid rgb(224, 224, 224);\n    border-radius: 8px;\n    cursor: ", ";\n    width: 100%;\n    height: 200px;\n    margin: 8px 0;\n\n    &:active {\n        cursor: ", ";\n    }\n"])), function (props) {
  return props.isEditable ? 'grab' : 'auto';
}, function (props) {
  return props.isEditable ? 'grabbing' : 'auto';
});
var MainSection = styled__default["default"].div(_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral(["\n\twidth: 100%;\n\tpadding: 8px 0;\n"])));
styled__default["default"].div(_templateObject4$6 || (_templateObject4$6 = _taggedTemplateLiteral(["\n\twidth: 350px;\n\tpadding: 8px;\n    border: 1px solid rgb(224, 224, 224);\n    margin-top: 16px;\n    border-radius: 8px;\n    height: calc(100vh - 100px);\n    overflow-y: scroll;\n"])));
var Container$5 = styled__default["default"].div(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["\n\tdisplay: flex;\n\tflex-direction: row;\n    background-color: #ffffff;\n    border-radius: 8px;\n"])));
...
function createCacheKey(config) {
  var cleanedConfig = _extends$j({}, config);
...
function makeUseAxios(configureOptions) {
  ...
  function configure(options) {
    ...
    if (options.defaultOptions !== undefined) {
      defaultOptions = _extends$j({}, DEFAULT_OPTIONS, options.defaultOptions);
    }
  }
  ...
  function tryStoreInCache(config, response) {
    ...
    var responseForCache = _extends$j({}, response);
  ...
  function useAxios(_config, _options) {
    ...
    var options = React__default["default"].useMemo(function () {
      return _extends$j({}, defaultOptions, _options);
    }, // eslint-disable-next-line react-hooks/exhaustive-deps
    ...
    var refetch = React__default["default"].useCallback(function (configOverride, options) {
      ...
      return request(withCancelToken(_extends$j({}, config, isReactEvent(configOverride) ? null : configOverride)), _extends$j({
        useCache: false
      }, options), dispatch);
...
request.interceptors.request.use(function (oldAxiosConfig) {
  var _oldAxiosConfig$scope = oldAxiosConfig.scope,
      ...
      axiosConfig = _objectWithoutProperties$j(oldAxiosConfig, _excluded$w);
...
var _templateObject$l, _templateObject2$e;
styled__default["default"].div(_templateObject$l || (_templateObject$l = _taggedTemplateLiteral(["\n    margin: 0;\n    position: absolute;\n    top: 50%;\n    -ms-transform: translateY(-50%);\n    transform: translateY(-50%);\n"])));
var NoRecordContainer = styled__default["default"].div(_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral(["\n    height: 70%; \n    width: 100%;\n    margin: 0;\n    position: absolute;\n    top: 50%;\n    -ms-transform: translateY(-50%);\n    transform: translateY(-50%);\n"])));

var _style, _path$f, _ellipse, _path2$2, _circle, _circle2, _g$3, _path3, _path4, _circle3, _path5, _path6, _path7, _path8, _path9, _path10, _path11, _path12, _path13, _path14, _path15, _circle4, _circle5, _path16, _g2;
...
function SvgNoRecords(_ref) {
  var title = _ref.title,
      titleId = _ref.titleId,
      props = _objectWithoutProperties$i(_ref, _excluded$v);

  return /*#__PURE__*/React__namespace.createElement("svg", _extends$i({
    id: "no-records_svg__Layer_1",
    ...
    id: titleId
  }, title) : null, _style || (_style = /*#__PURE__*/React__namespace.createElement("style", null, ".no-records_svg__st1{opacity:.1;fill:#0084bf}.no-records_svg__st2{opacity:.5}.no-records_svg__st6{fill:#6b89f2}.no-records_svg__st7{fill:#fff}.no-records_svg__st10{fill:#71bdd1}.no-records_svg__st12{fill:#545454}")), _path$f || (_path$f = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st1",
    d: "M63.3 23.1c4.4 1.6 7.1 8.5 8 12.7 1 5 1 10.8 4.5 14.9 1.3 1.6 3.1 2.8 4.2 4.5 2.8 4.4-.1 9-3.5 12-1.5 1.4-3.2 2.6-5 3.7-1.6 1-3.4 1.5-4.7 2.8-2.8 2.7-4.5 6.5-4.9 10.4-.2 2-.6 3.3-1.9 4.8-3.5 4.3-9 3.6-13.4 1.1-2.3-1.3-4.4-3.1-6.2-5-2.1-2.3-3.1-5.2-5-7.6-2-2.4-4.8-4-7.8-4.8-2.8-.7-5.6-.4-8-2-2-1.3-3.7-3.4-4.9-5.5-3.7-6.8 1.5-16.2 8.3-18.7 2.5-.9 5.3-1 7.9-.2.2.1.5.2.7.1.4-.1.5-.7.5-1.2 0-4.1-.8-8.2 1.8-11.7 3.3-4.4 9.8-5.6 15-4.8 0 0 1.9-2.7 2.2-3 1-1 2.2-1.8 3.4-2.4 2.8-1.3 6-1.1 8.8-.1z"
  })), _ellipse || (_ellipse = /*#__PURE__*/React__namespace.createElement("ellipse", {
    transform: "rotate(-48.511 27.909 81.95)",
    className: "no-records_svg__st1",
    cx: 27.9,
    cy: 82,
    rx: 3.6,
    ...
    d: "M23 39c-.5 0-1-.2-1.3-.5-.8-.7-.9-2-.2-2.9.7-.8 2-.9 2.9-.2.4.4.6.9.7 1.4 0 .5-.1 1.1-.5 1.5-.5.4-1.1.7-1.6.7zm0-3.2c-.3 0-.6.1-.9.4-.4.5-.4 1.2.1 1.6.5.4 1.2.4 1.6-.1.2-.2.3-.5.3-.8 0-.3-.2-.6-.4-.8-.2-.2-.5-.3-.7-.3z",
    fill: "#ccb03b"
    ...
    className: "no-records_svg__st2"
  }, /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-40.624 30.82 26.889)",
    className: "no-records_svg__st6",
    d: "M30.4 25.3h.9v3.3h-.9z"
  }), /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-40.872 30.818 26.888)",
    className: "no-records_svg__st6",
    d: "M29.2 26.4h3.3v.9h-3.3z"
  }))), _path3 || (_path3 = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st7",
    d: "M63.4 75.4s4 4.9 7.7 0M63.4 75.4s3.6 5 7.5.2c0 0 2.3-3.5-.7-6.2L59.7 55.8l-1.8 1.4-2.9-3.6-3.7 2.2 2.8 4-1.5 1.3"
  })), _path4 || (_path4 = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st7",
    d: "M43.9 58c-8.6 0-15.5-7-15.5-15.5 0-8.6 7-15.5 15.5-15.5s15.5 7 15.5 15.5S52.5 58 43.9 58zm0-27.8c-6.8 0-12.3 5.5-12.3 12.3s5.5 12.3 12.3 12.3 12.3-5.5 12.3-12.3-5.5-12.3-12.3-12.3z"
    ...
    d: "M46.7 30.5c-.9-.2-1.9-.3-2.8-.3-6.7 0-12.2 5.5-12.2 12.2 0 2.6.8 5 2.2 7-.3-1.2-.5-2.4-.5-3.7 0-7.7 5.8-14.2 13.3-15.2z",
    opacity: 0.12,
    fill: "#0084bf"
  })), _path6 || (_path6 = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st10",
    d: "M43.9 55.2c-7 0-12.7-5.7-12.7-12.7 0-7 5.7-12.7 12.7-12.7s12.7 5.7 12.7 12.7c0 7-5.7 12.7-12.7 12.7zm0-24.8c-6.7 0-12.1 5.4-12.1 12.1 0 6.7 5.4 12.1 12.1 12.1S56 49.2 56 42.5c0-6.7-5.4-12.1-12.1-12.1z"
  })), _path7 || (_path7 = /*#__PURE__*/React__namespace.createElement("path", {
    fill: "#feefac",
    d: "M61.6 58.2l-7 5.6-2-2.5 7.1-5.5z"
  })), _path8 || (_path8 = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st10",
    d: "M43.9 58.8c-9 0-16.3-7.3-16.3-16.3s7.3-16.3 16.3-16.3 16.3 7.3 16.3 16.3-7.3 16.3-16.3 16.3zm0-32c-8.7 0-15.7 7-15.7 15.7s7 15.7 15.7 15.7 15.7-7 15.7-15.7-7-15.7-15.7-15.7zM63.8 76.3L52.2 61.2l7.6-5.9 11.6 15.1-7.6 5.9zM53 61.3l10.9 14.2 6.7-5.1-10.9-14.2-6.7 5.1z"
  })), _path9 || (_path9 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-38.337 58.099 61.033)",
    className: "no-records_svg__st10",
    d: "M53.6 60.7h9v.6h-9z"
  })), _path10 || (_path10 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-37.761 60.775 68.36)",
    className: "no-records_svg__st10",
    d: "M60.5 62.9h.6v10.9h-.6z"
  })), _path11 || (_path11 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-37.761 62.622 66.93)",
    className: "no-records_svg__st10",
    d: "M62.3 61.5h.6v10.9h-.6z"
  })), _path12 || (_path12 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-37.761 64.277 65.644)",
    className: "no-records_svg__st10",
    d: "M64 60.2h.6v10.9H64z"
  })), _path13 || (_path13 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-37.577 56.642 55.307)",
    className: "no-records_svg__st10",
    d: "M56.3 53.2h.6v4.2h-.6z"
  })), _path14 || (_path14 = /*#__PURE__*/React__namespace.createElement("path", {
    transform: "rotate(-37.577 53.113 58.248)",
    className: "no-records_svg__st10",
    d: "M52.8 56.2h.6v4.2h-.6z"
  })), _path15 || (_path15 = /*#__PURE__*/React__namespace.createElement("path", {
    className: "no-records_svg__st10",
    d: "M67.2 77.9c-1.3 0-2.6-.6-3.6-1.8l-.2-.2L71 70l.2.3c.6.9.9 1.8.9 2.7.1 2.7-2.2 4.9-4.9 4.9zm-3-2c.9.9 1.9 1.4 3 1.4 2.4 0 4.3-1.9 4.3-4.3 0-.7-.2-1.4-.7-2.1l-6.6 5z"
...
function SvgStats(_ref) {
  var title = _ref.title,
      titleId = _ref.titleId,
      props = _objectWithoutProperties$h(_ref, _excluded$u);
...
var Avatar = styled__default["default"].div(_templateObject$k || (_templateObject$k = _taggedTemplateLiteral(["\n    width: 50px;\n    height: 50px;\n    background: ", ";\n    overflow: hidden;\n\n    display: flex;\n    justify-content: center;\n    align-items: center;\n\n    & svg {\n        width: 100%;\n        height: 100%;\n    }\n"])), function (props) {
  return props.icon ? 'transparent' : 'silver';
});

var _templateObject$j, _templateObject2$d, _templateObject3$8, _templateObject4$5, _templateObject5$5, _templateObject6$2;
var themes = {
  blues: {
    active: '#2270b5',
    inactive: '#c6daef',
...
var GaugeHolder$1 = styled__default["default"].div(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral(["\n    width: 220px;\n    margin: 0 auto;\n    position: relative;\n    text-align: center;\n"])));
var CircleMask$1 = styled__default["default"].div(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["\n    width: 220px;\n    height: 106px;\n    padding: 5px 10px 0;\n    border-bottom: ", ";\n    position: relative;\n    text-align: center;\n    overflow: hidden;\n"])), function (props) {
...
var Circle$1 = styled__default["default"].div(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral(["\n    width: 200px;\n    height: 200px;\n    border-radius: 50%;\n    border: ", ";\n    position: relative;\n"])), function (props) {
...
var CircleInner = styled__default["default"].div(_templateObject4$5 || (_templateObject4$5 = _taggedTemplateLiteral(["\n    width: 200px;\n    height: 200px;\n    border-radius: 50%;\n    position: absolute;\n    top: -10px;\n    left: -10px;\n    border: 10px solid transparent;\n    border-bottom: ", ";\n    border-left: ", ";\n    transition: .3s ease-in-out;\n    transform: rotate(-45deg);\n\n    &:after {\n        content: \"\";\n        position: absolute;\n        width: 10px;\n        height: 10px;\n        border-radius: 50%;\n        background: white;\n        border: ", ";\n        left: 16px;\n        top: 18px;\n    }\n"])), function (props) {
...
var Percentage = styled__default["default"].div(_templateObject5$5 || (_templateObject5$5 = _taggedTemplateLiteral(["\n    margin: 20px;\n    font-weight: bold;\n    color: ", ";\n    font-size: 15px;\n    width: 100%;\n"])), function (props) {
...
var Table = styled__default["default"](components.Table)(_templateObject$i || (_templateObject$i = _taggedTemplateLiteral(["\n    background-color: #ffffff;\n\toverflow-x: scroll;\n\theight: unset;\n\n\t.ui-table {\n\t\twhite-space: nowrap;\n\n\t\t.ui-table-head-cell {\n\t\t\tmin-width: 190px;\n            background: ", ";\n            color: white;\n\t\t}\n\t\t.ui-table-body-cell {\n\t\t\tbackground-color: #ffffff !important;\n\t\t\tbackground: #ffffff !important;\n            min-width: 190px;\n\t\t}\n\t\t.ui-table-body-row:hover {\n\t\t\t.ui-table-body-cell {\n\t\t\t\tbackground-color: #F5FAFE !important;\n\t\t\t\tbackground: #F5FAFE !important;\n\t\t\t}\n\t\t}\n\t\t.selected {\n\t\t\t.ui-table-body-cell {\n\t\t\t\tbackground-color: #F5FAFE !important;\n\t\t\t\tbackground: #F5FAFE !important;\n\t\t\t}\n\t\t}\n\t\t.ui-table-body-row {}\n\t}\n"])), function (props) {
...
var ChartsContainer$1 = styled__default["default"].div(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["\n    border-radius: 8px;\n    height: ", ";\n    padding: 8px;\n    overflow-y: hidden;\n\n    &.full {\n        width: 100%;\n        height: 500px;\n    }\n"])), function (props) {
...
var SubChartContainer = styled__default["default"].div(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["\n    /* text-align: center;\n    margin: 0;\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    -ms-transform: translate(-50%, -50%);\n    transform: translate(-50%, -50%); */\n"])));
...
var TitleChart = function TitleChart(_ref) {
  var data = _ref.data,
      themeType = _ref.themeType;
  return /*#__PURE__*/jsxRuntime.jsx(Title$1, {
    data: data,
    themeType: themeType
  });
};
...
var _templateObject$e, _templateObject2$a, _templateObject3$7, _templateObject4$4, _templateObject5$4, _templateObject6$1;
var GaugeHolder = styled__default["default"].div(_templateObject$e || (_templateObject$e = _taggedTemplateLiteral(["\n    width: 220px;\n    margin: 0 auto;\n    position: relative;\n    text-align: center;\n"])));
var CircleMask = styled__default["default"].div(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n    width: 220px;\n    height: 106px;\n    padding: 5px 10px 0;\n    border-bottom: ", ";\n    position: relative;\n    text-align: center;\n    overflow: hidden;\n"])), function () {
  return '1px solid #ecebeb';
});
var Circle = styled__default["default"].div(_templateObject3$7 || (_templateObject3$7 = _taggedTemplateLiteral(["\n    width: 200px;\n    height: 200px;\n    border-radius: 50%;\n    border: ", ";\n    position: relative;\n"])), function () {
  return '10px solid #ecebeb';
});
styled__default["default"].div(_templateObject4$4 || (_templateObject4$4 = _taggedTemplateLiteral(["\n    width: 200px;\n    height: 200px;\n    border-radius: 50%;\n    position: absolute;\n    top: -10px;\n    left: -10px;\n    border: 10px solid transparent;\n    border-bottom: '10px solid #ecebeb';\n    border-left: '10px solid #ecebeb';\n    transition: .3s ease-in-out;\n    transform: rotate(-45deg);\n\n    &:after {\n        content: \"\";\n        position: absolute;\n        width: 10px;\n        height: 10px;\n        border-radius: 50%;\n        background: #ecebeb;\n        border: '4px solid #ecebeb';\n        left: 16px;\n        top: 18px;\n    }\n"])));
styled__default["default"].div(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["\n    margin: 20px;\n    font-weight: bold;\n    color: #ecebeb;\n    font-size: 15px;\n    width: 100%;\n"])));
    ...
    if (widget_type !== 'title' && !(widgetData !== null && widgetData !== void 0 && widgetData.query_data)) {
      return /*#__PURE__*/jsxRuntime.jsx(components.Flex, {
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(NoRecordContainer, {
          children: /*#__PURE__*/jsxRuntime.jsx(SvgNoRecords, {
            style: {
              width: '100%',
              height: '100%'
            }
...
var WidgetContainer = styled__default["default"].div(_templateObject$d || (_templateObject$d = _taggedTemplateLiteral(["\n    position: absolute;\n    top: 50%;\n    left: 50%;\n    transform: translate(-50%, -50%);\n    width:100%;\n\n    & .md{\n        padding:0 !important;\n    }\n"])));
var CloseButton = styled__default["default"](admin.Button)(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["\n    z-index: 999;\n    height: 25px;\n    width: 25px;\n    border-radius: 50%;\n    box-shadow: 0px 2px 15px rgba(60, 67, 83, 0.25);\n    border: none;\n    color: #7A5EF3;\n    font-weight: 900;\n    font-size: 12px;\n\n"])));
...
var _templateObject$c, _templateObject2$8, _templateObject3$6, _templateObject4$3, _templateObject5$3;
var Container$4 = styled__default["default"].div(_templateObject$c || (_templateObject$c = _taggedTemplateLiteral(["\n\tdisplay: flex;\n\tjustify-content: space-between;\n\talign-items: flex-start;\n\tbackground: #ffffff;\n\tborder-radius: 10px;\n\tpadding: 60px 30px 36px 30px;\n"])));
var Heading = styled__default["default"].h4(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["\n\tfont-style: normal;\n\tfont-weight: bold;\n\tfont-size: 22px;\n\tline-height: 26px;\n\tletter-spacing: 0.02em;\n\tmargin-block-start: 0em;\n\tmargin-block-end: 0em;\n\n\t/* Black */\n\n\tcolor: #000000;\n"])));
var Content = styled__default["default"].p(_templateObject3$6 || (_templateObject3$6 = _taggedTemplateLiteral(["\n\tfont-style: normal;\n\tfont-weight: normal;\n\tfont-size: 16px;\n\tline-height: 19px;\n\tletter-spacing: 0.02em;\n\tmargin-block-start: 0em;\n\tmargin-block-end: 0em;\n\n\t/* Black */\n\n\tcolor: #000000;\n"])));
var IcContainer = styled__default["default"].div(_templateObject4$3 || (_templateObject4$3 = _taggedTemplateLiteral(["\n\tmax-width: 17%;\n\tmin-width: 10%;\n\t@media (max-width: _md) {\n\t\tdisplay: none;\n\t}\n"])));
var Wrapper = styled__default["default"].div(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["\n\tmax-width: 45%;\n\t@media (max-width: _md) {\n\t\tmax-width: 100%;\n\t}\n"])));
...
function SvgIcEmptyNonFunded(_ref) {
  ...
    fill: "#000"
  }))), _defs$2 || (_defs$2 = /*#__PURE__*/React__namespace.createElement("defs", null, /*#__PURE__*/React__namespace.createElement("clipPath", {
    id: "ic-empty-non-funded_svg__clip0"
  }, /*#__PURE__*/React__namespace.createElement("path", {
    fill: "#fff",
    transform: "translate(0 .383)",
    d: "M0 0h168.119v250.285H0z"
  })))));
}
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(Container$4, {
    children: [/*#__PURE__*/jsxRuntime.jsxs(Wrapper, {
      children: [/*#__PURE__*/jsxRuntime.jsx(Heading, {
        ...
        children: "Looks like you do not have any records for this section"
      })]
    }), /*#__PURE__*/jsxRuntime.jsx(IcContainer, {
      children: /*#__PURE__*/jsxRuntime.jsx(SvgIcEmptyNonFunded, {
        height: height,
        width: width,
        style: {
          marginLeft: 20
...
var ViewEditDashboardComponent = function ViewEditDashboardComponent(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(components.Flex, {
      ...
      children: /*#__PURE__*/jsxRuntime.jsx(Container$5, {
        children: /*#__PURE__*/jsxRuntime.jsxs(MainSection, {
          children: [widgets.length <= 0 && /*#__PURE__*/jsxRuntime.jsx(EmptyState, {}), widgets.length > 0 && /*#__PURE__*/jsxRuntime.jsx(ResponsiveGridLayout, {
            className: "layout",
            rowHeight: 30,
...
var Select$1 = function Select(_ref) {
  var control = _ref.control,
      name = _ref.name,
      rest = _objectWithoutProperties$j(_ref, _excluded$h);
  ...
  var _useController = hooks.useController({
    ...
    defaultValue: rest.defaultValue
      ...
      selectProps = _objectWithoutProperties$j(_useController$field, _excluded2$5);
...
var SwitchControled = function SwitchControled(_ref) {
  var control = _ref.control,
      name = _ref.name,
      rest = _objectWithoutProperties$j(_ref, _excluded$g);
  ...
  var _useController = hooks.useController({
    ...
    defaultValue: rest.defaultValue
      ...
      _useController$field = _useController.field,
      ref = _useController$field.ref,
      switchProps = _objectWithoutProperties$j(_useController$field, _excluded2$4);
...
var TagSelectControled = function TagSelectControled(_ref) {
  var control = _ref.control,
      name = _ref.name,
      rest = _objectWithoutProperties$j(_ref, _excluded$f);
  ...
  var _useController = hooks.useController({
    ...
    defaultValue: rest.defaultValue
      ...
      _useController$field = _useController.field,
      ref = _useController$field.ref,
      tagSelectProps = _objectWithoutProperties$j(_useController$field, _excluded2$3);
...
var ToggleControled = function ToggleControled(_ref) {
  var control = _ref.control,
      name = _ref.name,
      rest = _objectWithoutProperties$j(_ref, _excluded$e);
  ...
  var _useController = hooks.useController({
    ...
    defaultValue: rest.defaultValue
      ...
      _useController$field = _useController.field,
      ref = _useController$field.ref,
      toggleProps = _objectWithoutProperties$j(_useController$field, _excluded2$2);
...
var SingleDatePickerControlled = function SingleDatePickerControlled(_ref) {
  var control = _ref.control,
      name = _ref.name,
      rest = _objectWithoutProperties$j(_ref, _excluded$d);
  ...
  var _useController = hooks.useController({
    ...
    defaultValue: rest.defaultValue
      ...
      _useController$field = _useController.field,
      ref = _useController$field.ref,
      singleDatePickerProps = _objectWithoutProperties$j(_useController$field, _excluded2$1);
...
var PasswordInput = function PasswordInput(_ref, ref) {
  var _ref$className = _ref.className,
      ...
      props = _objectWithoutProperties$j(_ref, _excluded$c);
  ...
  if (optionsListKey) {
    ...
    if (asyncFields) {
      var _asyncFields$defaultP = asyncFields.defaultParams,
          ...
          restAsyncFields = _objectWithoutProperties$j(asyncFields, _excluded$b);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _ref2 = paramsOld || {}, filters = _ref2.filters, rest = _objectWithoutProperties$j(_ref2, _excluded$a);
              ...
              if ((asyncOptions.grouped || []).length) {
                _ref3 = (asyncOptions === null || asyncOptions === void 0 ? void 0 : (_asyncOptions$grouped = asyncOptions.grouped) === null || _asyncOptions$grouped === void 0 ? void 0 : (_asyncOptions$grouped2 = _asyncOptions$grouped[0]) === null || _asyncOptions$grouped2 === void 0 ? void 0 : _asyncOptions$grouped2.defaultParams) || {}, oldFilters = _ref3.filters, newRest = _objectWithoutProperties$j(_ref3, _excluded2);
...
var Select = function Select(props, ref) {
  ...
  var options = props.options,
      ...
      rest = _objectWithoutProperties$j(props, _excluded$9);
...
var SelectController$1 = function SelectController(_ref) {
  var itemKey = _ref.itemKey,
      ...
      rest = _objectWithoutProperties$j(_ref, _excluded$8);
...
var _templateObject$a, _templateObject2$6, _templateObject3$5, _templateObject4$2, _templateObject5$2, _templateObject6, _templateObject7, _templateObject8, _templateObject9;
...
var PopoverCard = styled__default["default"].div(_templateObject3$5 || (_templateObject3$5 = _taggedTemplateLiteral(["\n    cursor: pointer;\n    display: flex;\n    justify-content: space-between;\n\tpointer-events: all;\n\talign-items: center;\n\tpadding: 8px;\n\tcolor: #333;\n\tfont-weight: normal;\n    border: 1px solid transparent;\n\n    &:not(:last-child) {\n        border-bottom: 1px solid #eee;\n    }\n\n    &:hover {\n\t\tbackground: #eee;\n\t\tcolor: rgb(116, 131, 143);\n    }\n    .card-button {\n        border-radius: 50%;\n        background-color: #fff;\n        &:hover {\n            background-color: #000;\n            color: #fff;\n        }\n    }\n"])));
...
var PartnerTitle$1 = styled__default["default"].p(_templateObject3$4 || (_templateObject3$4 = _taggedTemplateLiteral(["\n\tmargin: 0px;\n\tmargin-top: 8vh;\n\tfont-weight: bold;\n\tfont-size: 13px;\n\tline-height: 22px;\n\tletter-spacing: 0.02em;\n\tcolor: #000000;\n"])));
...
var SelectController = function SelectController(_ref) {
  var previousValue = _ref.previousValue,
      ...
      rest = _objectWithoutProperties$j(_ref, _excluded$3);
...
var _templateObject$7, _templateObject2$3, _templateObject3$3;
...
var Label$1 = styled__default["default"].div(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["\n    margin: 8px 0;\n"])));
        ...
        children: /*#__PURE__*/jsxRuntime.jsx(Row, {
          children: controls === null || controls === void 0 ? void 0 : controls.map(function (controlItem) {
            ...
            var _controlItem$span = controlItem.span,
                ...
                _objectWithoutProperties$j(controlItem, _excluded$1);
...
var _templateObject$6, _templateObject2$2, _templateObject3$2;
...
var Label = styled__default["default"].label(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n\tmargin-bottom: _s2;\n\tdisplay: inline-block;\n\tfont-size: 14px;\n\tcolor: #393F70;\n\tline-height: 20px;\n\tfont-weight: normal;\n\t&.bold {\n\t\tfont-weight: bold;\n\t\tline-height: 1.43;\n\t\tmargin-bottom: 0px;\n\t}\n\n\t&.row {\n\t\tfont-style: normal;\n\t\tfont-weight: normal;\n\t\tfont-size: 12px;\n\t\tline-height: 14px;\n\t\t/* identical to box height */\n\t\tmargin-bottom: 0px;\n\t\tletter-spacing: 0.02em;\n\t\tcolor: #4f4f4f;\n\t\t&.bordered {\n\t\t\tpadding: 0px 28px;\n\t\t\tmax-width: 100%;\n\t\t\tmargin-bottom: 10px;\n\t\t}\n\t}\n\n\t&.new {\n\t\tfont-size: 12px;\n\t\tfont-weight: 700;\n\t\tcolor: #4F4F4F;\n\t}\n\t&.big {\n\t\tfont-weight: bold;\n\t\tfont-size: 12px;\n\t\tcolor: #000000;\n\t\tmargin-bottom: 8px;\n\t\t/* text-transform: uppercase; */\n\t}\n"])));
    ...
    children: /*#__PURE__*/jsxRuntime.jsx(Row, {
      ...
      children: controls === null || controls === void 0 ? void 0 : controls.map(function (control) {
        ...
        var _fields$control$name = fields[control.name],
            ...
            _objectWithoutProperties$j(_fields$control$name, _excluded);
...
var Title = styled__default["default"].div(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["\n\nfont-weight: 500;\nfont-size: 14px;\nmargin-bottom: 8px;\n"])));
styled__default["default"].div(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["\n    margin: 16px 0;\n"])));
...
var SaveDashboardButton = function SaveDashboardButton(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsx(SaveDashboardButtonContainer, {
    children: /*#__PURE__*/jsxRuntime.jsx(components.Flex, {
      style: {
        gap: '8px'
      },
...
var UpdateDashboard = function UpdateDashboard(_ref) {
  ...
  return /*#__PURE__*/jsxRuntime.jsxs(jsxRuntime.Fragment, {
    children: [/*#__PURE__*/jsxRuntime.jsx(SaveDashboardButton, {
...
var VariableFilters = function VariableFilters(_ref) {
  var _ref$queryVariables = _ref.queryVariables,
      ...
      _ref$dashboard_id = _ref.dashboard_id,
      dashboard_id = _ref$dashboard_id === void 0 ? '' : _ref$dashboard_id;
  ...
  var controls = queryVariables === null || queryVariables === void 0 ? void 0 : queryVariables.map(function (item) {
    item.widgetId.forEach(function (id) {
      values["".concat(item === null || item === void 0 ? void 0 : item.name, "/").concat(id)] = (item === null || item === void 0 ? void 0 : item.default_value) || '';
    });
    return _objectSpread2(_objectSpread2({}, (item === null || item === void 0 ? void 0 : item.type) === 'text' ? text_control : date_control), {}, {
      name: "".concat(item === null || item === void 0 ? void 0 : item.name, "/").concat(item.widgetId[0]),
      label: item === null || item === void 0 ? void 0 : item.label,
      value: (item === null || item === void 0 ? void 0 : item.default_value) || '',
      rules: {
        required: (item === null || item === void 0 ? void 0 : item.is_required) === 'true' && 'Required'
      }
    });
  });
  ...
  var _API$BULK_UPDATE_ANAL = API.BULK_UPDATE_ANALYTICS_WIDGETS,
      apiMethod = _API$BULK_UPDATE_ANAL.apiMethod,
      apiScope = _API$BULK_UPDATE_ANAL.apiScope,
      apiName = _API$BULK_UPDATE_ANAL.apiName;

  var refactorPayload = function refactorPayload() {
    var query_variable_values = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
    var payload = [];
    var uniqueIds = [];
    Object.keys(query_variable_values).forEach(function (key) {
      var nameKey = key.split('/')[0];
    ...
    Object.keys(values).forEach(function (key) {
      var widgetID = key.split('/')[1];
      var nameKey = key.split('/')[0];

      var obj = _defineProperty({}, nameKey, values[key]);

      var index = uniqueIds.indexOf(widgetID);
      ...
      if (index > -1) {
        ...
        uniqueIds = [].concat(_toConsumableArray(uniqueIds), [widgetID]);
      }
    });
    return payload;
  };

  var bulkUpdateWidgetAPI = useRequest(apiMethod, true, apiScope)(apiName);

  var bulkUpdate = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return bulkUpdateWidgetAPI.trigger({
                params: {
                  widgets: payload
                }
              });
    ...
    return function bulkUpdate(_x) {
      return _ref2.apply(this, arguments);
    };
  }();

  var onSubmit = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator$1( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(data) {
      var payload, newData;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              components.toast.success('Variable Filters Applied');
              payload = refactorPayload(_objectSpread2(_objectSpread2({}, queryVariableValues), data));
              newData = {};
              Object.keys(data).forEach(function (keys) {
                var nameKey = keys.split('/')[0];
            ...
            case 7:
              setQueryVariableValues(_objectSpread2(_objectSpread2({}, queryVariableValues), newData));
              setErrors({});
...
var DashboardPage = function DashboardPage(_ref) {
  ...
  var _useState11 = React.useState({}),
      ...
      dashboardQueryVariableValues = _useState12[0],
      setDashboardQueryVariableValues = _useState12[1];
  ...
  var breadCrumbs = [{
    ...
    key: 'Dashboard page',
    title: (dashboard_data === null || dashboard_data === void 0 ? void 0 : dashboard_data.name) || "untitled"
  }];

  var handlebreadCrumbClick = function handlebreadCrumbClick(details) {
    if (details.href) {
  ...
  widgetsMappingData === null || widgetsMappingData === void 0 ? void 0 : widgetsMappingData.forEach(function (item) {
    ...
    if ((itemQv === null || itemQv === void 0 ? void 0 : itemQv.length) > 0) {
      itemQv.forEach(function (qv) {
        var _query_variables;

        var isNotAlreadyAdded = (_query_variables = query_variables) === null || _query_variables === void 0 ? void 0 : _query_variables.filter(function (x) {
          return (x === null || x === void 0 ? void 0 : x.name) === (qv === null || qv === void 0 ? void 0 : qv.name) && (x === null || x === void 0 ? void 0 : x.type) === qv.type;
        });

        if (isNotAlreadyAdded.length === 0) {
          query_variables = [].concat(_toConsumableArray(query_variables), [_objectSpread2(_objectSpread2({}, qv), {}, {
            widgetId: [item.id]
          })]);
        } else {
          var index = query_variables.indexOf(isNotAlreadyAdded[0]);
          query_variables[index].widgetId = [].concat(_toConsumableArray(query_variables[index].widgetId), [item.id]);
        }
      });
    }
  });
  return /*#__PURE__*/jsxRuntime.jsxs(components.Flex, {
    ...
    children: [/*#__PURE__*/jsxRuntime.jsxs(Container$6, {
      children: [/*#__PURE__*/jsxRuntime.jsx(components.Flex, {
        children: /*#__PURE__*/jsxRuntime.jsx(components.Text, {
          bold: true,
          children: (dashboard_data === null || dashboard_data === void 0 ? void 0 : dashboard_data.name) || 'Untitled'
        })
      }), /*#__PURE__*/jsxRuntime.jsxs(components.Flex, {
        alignItems: "center",
        style: {
        ...
        children: [/*#__PURE__*/jsxRuntime.jsx(Toggle__default["default"], {
          ...
          style: {
            display: dashboardMode === 'edit' && 'none'
          },
          children: dashboardMode === 'view' ? 'Refresh' : 'Update Dashboard'
        })]
      })]
    }), /*#__PURE__*/jsxRuntime.jsx(components.Flex, {
      marginBottom: "16px",
    ...
    }) : /*#__PURE__*/jsxRuntime.jsxs(DashboardContainer, {
